export const regionMapCN: { [key: string]: string }[] = [
    { name: '中国', code: '+86' },
    { name: '阿富汗', code: '+93' },
    { name: '阿尔巴尼亚', code: '+355' },
    { name: '阿尔及利亚', code: '+213' },
    { name: '安道尔共和国', code: '+376' },
    { name: '安哥拉', code: '+244' },
    { name: '安圭拉岛', code: '+1264' },
    { name: '阿森松', code: '+247' },
    ...
    { name: '喀麦隆', code: '+237' },
    { name: '加拿大', code: '+1' },
    { name: '佛得角共和国', code: '+238' },
    { name: '开曼群岛', code: '+1345' },
    { name: '中非共和国', code: '+236' },
    { name: '乍得', code: '+235' },
    { name: '智利', code: '+56' },
    { name: '哥伦比亚', code: '+57' },
    { name: '科摩罗伊斯兰联邦共和国', code: '+269' },
    { name: '刚果共和国', code: '+242' },
